...
const colorMap = {
  blue: { accent: "text-[#8FC5A3]", bg: "bg-[#4F8B7A]/10", border: "border-[#4F8B7A]/20" },
  green: { accent: "text-dashboard-accent", bg: "bg-dashboard-accent/10", border: "border-dashboard-accent/20" },
  yellow: { accent: "text-dashboard-accent-secondary", bg: "bg-dashboard-accent-secondary/10", border: "border-dashboard-accent-secondary/20" },
  purple: { accent: "text-dashboard-accent", bg: "bg-dashboard-accent/10", border: "border-dashboard-accent/20" },
  pink: { accent: "text-dashboard-accent-secondary", bg: "bg-dashboard-accent-secondary/10", border: "border-dashboard-accent-secondary/20" },
}
    ...
    return (
      <div className="group relative overflow-hidden rounded-2xl border border-dashboard-border bg-dashboard-surface p-5 transition-all duration-300">
        <div className="flex items-center gap-2 mb-5">
          <div className="w-8 h-8 rounded-lg bg-dashboard-accent/10 shadow-[0_0_14px_rgba(169,201,127,0.16)] flex items-center justify-center">
            <Package className="w-4 h-4 text-dashboard-accent" />
          </div>
          <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start justify-between gap-2">
                  <div className={cn(
                    ...
                    colors.bg,
                    colors.accent,
                    "shadow-[0_0_12px_rgba(169,201,127,0.12)]"
                  )}>
                    {product.icon}
                  </div>
                  {product.stock !== undefined && (
                    <span className={cn(
                      ...
                      product.stock > 0 ? "text-dashboard-accent bg-amber-500/10" :
