...
export const TopNavBar = memo(({
  ...
  return (
    <>
      <header className="relative z-40 flex w-full items-start justify-between gap-4 border-0 bg-transparent p-0 px-4 pb-2 pt-4 shadow-none outline-none before:hidden after:hidden md:px-8 md:pb-3 md:pt-6">
