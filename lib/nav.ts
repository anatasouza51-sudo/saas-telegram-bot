...
export const NAV_ITEMS: NavItem[] = [
  ...
  { title: "Postagens", href: "/posts", icon: "Megaphone", capability: "posts.manage" },
  { title: "Grupos & Canais", href: "/channels", icon: "Radio", capability: "posts.manage" },
  { title: "Biblioteca de Mídias", href: "/media", icon: "Images", capability: "posts.manage" },
  { title: "Automações", href: "/automations", icon: "Zap", capability: "posts.manage" },
