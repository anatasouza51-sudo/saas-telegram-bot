...
export const SYSTEM_NAV: NavItem[] = [
  ...
  { title: "Admin · Gateways", href: "/admin/gateways", icon: "ShieldCheck", capability: "settings.manage" },
  { title: "Admin · Comissão", href: "/admin/commission", icon: "Coins", capability: "settings.manage" },
]
