...
export default function DashboardPage() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-7xl space-y-4 px-2 pt-1 sm:space-y-5 md:px-4">
...
function DashboardSkeleton() {
  return (
    <div className="mx-auto w-full max-w-7xl space-y-4 px-2 pt-1 md:px-4">
